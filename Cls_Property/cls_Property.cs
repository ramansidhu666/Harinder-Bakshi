...
public DataTable GetExclusiveListing()
        ...
        public DataTable GetSoldListing()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = " usp_GetAllSoldListing";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public DataTable GetSoldDetail(int DreamHouseId)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from SoldListing where Id=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public DataTable GetSoldForSlider(int DreamHouseId)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from SoldListingImages where DreamHouseId=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public int DeleteSold(int id)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete from SoldListing where id=@id;";
                cmd.Parameters.AddWithValue("@id", id);
                cmd.Connection = conn;
                if (conn.State == ConnectionState.Closed)
                {
        ...
        public int InsertSoldData(string Title, string filename, string Description, string Address, string Price, string Status, string Type, string Bed, string Bath, string Tax, string Mls, string Area)
        {
            int result = 0;
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_InsertSoldListing";
                cmd.Parameters.AddWithValue("@Title", Title);
                cmd.Parameters.AddWithValue("@ImageUrl", filename);
                cmd.Parameters.AddWithValue("@Description", Description);
                cmd.Parameters.AddWithValue("@Address", Address);
        ...
        public int InsertSoldImage(int DreamHouseId, string filename)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Insert into [SoldListingImages](DreamHouseId,ImageUrl) values(@DreamHouseId,@ImageUrl)";
                cmd.Parameters.AddWithValue("@DreamHouseId", DreamHouseId);
                cmd.Parameters.AddWithValue("@ImageUrl", filename);
