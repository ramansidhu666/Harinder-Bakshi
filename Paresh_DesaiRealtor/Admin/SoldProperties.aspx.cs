    ...
    public partial class SoldProperties : System.Web.UI.Page
    {
        ...
        protected void GrdBlogList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Deleterec")
            {
                ...
                int result = clsobj.DeleteSold(id);
                FillGridData();
            }
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int DreamHouseId = clsobj.InsertSoldData(txtName.Text, fileNameForFirstImage, txtDescription.Text, txtAddress.Text, txtPrice.Text,statustxt.Text,Typetxt.Text,Bedstxt.Text,Bathtxt.Text,Taxtxt.Text,Mlstxt.Text,Areatxt.Text);
                for (int i = 0; i < fileCollection.Count; i++)
                {
                    ...
                    if (uploadfile.ContentLength > 0)
                    {
                        ...
                        clsobj.InsertSoldImage(DreamHouseId, fileName);
