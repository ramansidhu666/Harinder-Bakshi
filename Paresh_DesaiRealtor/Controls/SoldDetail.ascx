<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SoldDetail.ascx.cs" Inherits="Property.Controls.SoldDetail" %>
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="property_inner_cntnt">
                    <ul class="w4rlisting-list-b">
                        ...
                        <li class="a"><span> <asp:Label ID="lbltx" runat="server" Text=""></asp:Label></span>Tax</li>
                </div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="roco_pro_info">
                        <h2 style="font-size: 19px !important">
                            <asp:Label ID="lblname" runat="server"></asp:Label>Harinder Bakshi</h2>
