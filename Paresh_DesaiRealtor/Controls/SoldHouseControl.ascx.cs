...
{
    public partial class SoldHouseControl : System.Web.UI.UserControl
    {
        #region Global
        ...
        void GetDreamHouseList()
        {
            try
            {
                DataTable dt = clsobj.GetSoldListing();
                if (dt.Rows.Count > 0)
                {
        ...
        protected void rptSearchResultList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Details")
                {
                        ...
                        Response.Redirect("~/SoldHouseDetailPage.aspx?Id=" + e.CommandArgument, false);
