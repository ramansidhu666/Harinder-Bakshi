<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SoldHouseControl.ascx.cs" Inherits="Property.Controls.SoldHouseControl" %>
<%--<div class="col-md-4">
                                    ...
                                    <div class="construction_bg">
                                       <div class="construction_hdng"><span><%# Eval("Title") %></span></div>
                                        <div class="construction_price"><span><%# Eval("Price") %></span></div>
                                         ...
                                         <asp:HyperLink ID="hypBoxreadmore" NavigateUrl='<%# Eval("Id", "~/SoldHouseDetailPage.aspx?ID={0}") %>' CssClass="read_more_btn3 new_btn" Text="Read More" runat="server"></asp:HyperLink>
                                        </div>
