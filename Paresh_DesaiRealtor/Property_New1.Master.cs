    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesFaceBookShare()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fbProprtyUrl.Content = string.Format("http://realtorharrybakshi.com/PropertyDetails.aspx?MLSID={0}&PropertyType={1}", dt.Rows[0]["MLS"].ToString(), dt.Rows[0]["pType"].ToString());
                //fbProprtySiteName.Content = "";
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //StrMenu.Append("</li>");
                StrMenu.Append("<a href='soldhouse.aspx' title='Sold Properties'>Sold Properties</a>");
                StrMenu.Append("</li>");
                //StrMenu.Append("<li>");
